...
const Nav: React.FC = () => {
  ...
  return (
    <nav className={styles.nav}>
        ...
        {isMenuOpen && (
          <AnimatePresence>
            ...
            >
              ...
              <motion.li variants={listItem} whileHover={{ scale: 1.1 }}>
                <Link
                  href="/files/ArifBatuhanYildirimogluCV.pdf"
                  target="_blank"
                  onClick={() => {
                    if (isMobile) setIsMenuOpen((prev) => !prev);
                  }}
                  download={'ArifBatuhanYildirimogluCV.pdf'}
                  style={{
                    display: 'flex',
                    alignItems: 'center',
                    gap: '0.5rem',
      ...
      <div className={styles.socialAndLocaleContainer}>
        ...
        >
          <AnimatePresence>
            <motion.ul className={styles.listSocial}>
